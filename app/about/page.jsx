...
const page = () => {
  return (
    <div className="max-w-6xl mx-auto p-3 space-y-4">
      ...
      <p>
        Welcome to our movie database! We are a team of movie enthusiasts who
        are passionate about the world of cinema. And to create a one-stop
      ...
      <p>
        ...
        the world of cinema. You can seauch for movies by title, director,
